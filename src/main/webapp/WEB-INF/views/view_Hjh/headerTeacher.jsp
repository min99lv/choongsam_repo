...
<nav>
    ...
    <h1>강사</h1>
        ...
        <ul class="submenu" id="myClassroomSubmenu">
            <li style="font-size: 13px;" onclick="location.href='myPageTeacher?user_seq=${user_seq}'">현재 수강 중인 강의</li>
           <li style="font-size: 13px;" onclick="location.href='gangyilistTeacher?user_seq=${user_seq}'">현재 수강 중인 강의</li>
        </ul>
