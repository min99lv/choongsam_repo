    ...
    <button id="markAttendance">출석인정</button><p>
   	...
   	<div>
   		<form id="exitForm" action="/api/progress/save" method="POST">
   			...
   			<input type="hidden" name="contsFinal" value="">
   			<input type="hidden" name="contsMax" value="">
   			<input type="hidden" name="videoLength" value="">
   		<button type="button" id="exitButton">나가기</button>
   	</form>
...
<script type="text/javascript">
    ...
    document.getElementById('exitButton').addEventListener('click', () => {
        ...
        document.querySelector('input[name="contsFinal"]').value = conts_final;
        document.querySelector('input[name="contsMax"]').value = conts_max;
        document.querySelector('input[name="videoLength"]').value = vdo_length;
